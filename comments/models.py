...
class DownloadInfo(models.Model):
    ...
    download_size = models.FloatField(blank=True, null=True)
...
class PicInfo(models.Model):
    ...
    pic_size = models.FloatField(blank=True, null=True)
    pic_md5 = models.CharField(max_length=255, blank=True, null=True)
    user = models.CharField(max_length=255, blank=True, null=True)
    pic_address = models.CharField(max_length=255, blank=True, null=True)
...
class VideoInfo(models.Model):
    ...
    video_author = models.CharField(max_length=255, blank=True, null=True)
